(ns happygapi.servicenetworking.services
  ...
  See: https://cloud.google.com/service-infrastructure/docs/service-networking/getting-starteddocs/reference/rest/v1/services"
...
(defn dnsRecordSets-get$
  ...
  Optional parameters: zone, domain, consumerNetwork, type

...
(defn listErrors$
  ...
  Optional parameters: pageToken, orderBy, returnPartialSuccess, filter, maxResults
...
(defn aggregatedList$
  ...
  Optional parameters: maxResults, orderBy, filter, pageToken, includeAllScopes, returnPartialSuccess

...
(defn get$
  ...
  [auth args]
  {:pre [(util/has-keys? args #{"project" "instance" "zone"})]}
  (util/get-response
   (http/get
    (util/get-url
     "https://compute.googleapis.com/compute/v1/projects/"
...
(defn updateAccessConfig$
  ...
  {:pre [(util/has-keys?
          args
          #{"networkInterface" "project" "instance" "zone"})]}
  (util/get-response
   (http/post
    (util/get-url
     "https://compute.googleapis.com/compute/v1/projects/"
...
(defn setDiskAutoDelete$
  ...
  {:pre [(util/has-keys?
          args
          #{"deviceName" "project" "instance" "zone" "autoDelete"})]}
  (util/get-response
   (http/post
    (util/get-url
     "https://compute.googleapis.com/compute/v1/projects/"
...
(defn detachDisk$
  ...
  {:pre [(util/has-keys?
          args
          #{"deviceName" "project" "instance" "zone"})]}
  (util/get-response
   (http/post
    (util/get-url
     "https://compute.googleapis.com/compute/v1/projects/"

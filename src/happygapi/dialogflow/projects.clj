...
(defn agent-environments-users-sessions-detectIntent$
  ...
  {:outputAudioConfig {:audioEncoding string,
   ...
   :queryInput {:event GoogleCloudDialogflowV2EventInput,
                :text GoogleCloudDialogflowV2TextInput,
                :audioConfig GoogleCloudDialogflowV2InputAudioConfig},
   :queryParams {:contexts [GoogleCloudDialogflowV2Context],
...
(defn agent-intents-list$
  ...
  Optional parameters: languageCode, pageToken, pageSize, intentView

(ns happygapi.logging.locations
  ...
  See: https://cloud.google.com/logging/docs/docs/reference/rest/v2/locations"
...
(defn buckets-views-setIamPolicy$
  "https://cloud.google.com/logging/docs/api/reference/rest/v2/locations/buckets/views/setIamPolicy
...
(defn buckets-views-getIamPolicy$
  "https://cloud.google.com/logging/docs/api/reference/rest/v2/locations/buckets/views/getIamPolicy
...
(defn buckets-views-testIamPermissions$
  "https://cloud.google.com/logging/docs/api/reference/rest/v2/locations/buckets/views/testIamPermissions

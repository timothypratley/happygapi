  ...
  (util/get-response
   (http/get
    (util/get-url
     ...
     "content/v2.1/{merchantId}/returnpolicy"
     #{:merchantId}
     parameters)
    (merge-with
     merge
...
(defn insert$
  ...
  {:nonFreeReturnReasons [string],
   ...
   :name string,
   :country string,
   :policy {:lastReturnDate string, :type string, :numberOfDays string},
   :label string,
...
(defn custombatch$
  ...
  {:entries [{:returnPolicy ReturnPolicy,
              :method string,
              :returnPolicyId string,
              :batchId integer,
              :merchantId string}]}
  ...
  (util/get-response
   (http/post
    (util/get-url
     "https://shoppingcontent.googleapis.com/"
     "content/v2.1/returnpolicy/batch"
     #{}
     parameters)
    (merge-with
     merge

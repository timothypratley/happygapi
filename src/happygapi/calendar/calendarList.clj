...
(defn list$
  ...
  Optional parameters: pageToken, showHidden, showDeleted, minAccessRole, syncToken, maxResults
...
(defn watch$
  ...
  Optional parameters: maxResults, pageToken, showDeleted, minAccessRole, showHidden, syncToken

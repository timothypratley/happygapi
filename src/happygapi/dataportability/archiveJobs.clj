(ns happygapi.dataportability.archiveJobs
  ...
  See: https://developers.google.com/data-portabilitydocs/reference/rest/v1/archiveJobs"
  (:require [cheshire.core :as json]
            [clj-http.client :as http]
            [happy.util :as util]))

(defn getPortabilityArchiveState$
  "https://developers.google.com/data-portabilityapi/reference/rest/v1/archiveJobs/getPortabilityArchiveState
...
(defn retry$
  "https://developers.google.com/data-portabilityapi/reference/rest/v1/archiveJobs/retry

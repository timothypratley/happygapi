...
(defn image-redact$
  ...
  {:includeFindings boolean,
   ...
   :inspectConfig {:infoTypes [GooglePrivacyDlpV2InfoType],
...
(defn dlpJobs-list$
  ...
  Optional parameters: orderBy, type, filter, pageToken, pageSize, locationId
...
(defn jobTriggers-list$
  ...
  Optional parameters: orderBy, filter, pageToken, locationId, pageSize
  Lists job triggers.

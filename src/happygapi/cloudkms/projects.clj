...
(defn locations-keyRings-cryptoKeys-list$
  ...
  Optional parameters: pageToken, pageSize, filter, versionView, orderBy
...
(defn locations-keyRings-cryptoKeys-cryptoKeyVersions-patch$
  ...
  {:algorithm string,
   ...
   :importJob string,
   :attestation {:certChains CertificateChains,
                 :content string,
                 :format string},
   :protectionLevel string,
   :destroyTime string,
...
(defn locations-keyRings-cryptoKeys-cryptoKeyVersions-list$
  ...
  Optional parameters: view, orderBy, pageToken, pageSize, filter

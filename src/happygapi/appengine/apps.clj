...
(defn services-patch$
  ...
  {:id string, :name string, :split {:shardBy string, :allocations {}}}
...
(defn services-versions-patch$
  ...
  {:runtimeChannel string,
   ...
   :vm boolean,
   :betaSettings {},
   :handlers [{:apiEndpoint ApiEndpointHandler,
...
(defn domainMappings-patch$
  ...
  {:name string,
   ...
   :id string,
   :resourceRecords [{:name string, :type string, :rrdata string}]}

...
(defn list$
  ...
  Optional parameters: pageToken, pageSize, teacherId, courseStates, studentId
...
(defn announcements-list$
  ...
  Optional parameters: announcementStates, orderBy, pageToken, pageSize
...
(defn courseWork-list$
  ...
  Optional parameters: pageSize, courseWorkStates, orderBy, pageToken
...
(defn courseWork-studentSubmissions-list$
  ...
  Optional parameters: late, pageToken, pageSize, states, userId

(ns happygapi.keep.notes
  ...
  See: https://support.google.com/keepapi/reference/rest/v1/notes"
  (:require [cheshire.core :as json]
            [clj-http.client :as http]
            [happy.util :as util]))

(defn delete$
  "https://support.google.com/keepapi/reference/rest/v1/notes/delete
...
(defn get$
  "https://support.google.com/keepapi/reference/rest/v1/notes/get
...
(defn list$
  "https://support.google.com/keepapi/reference/rest/v1/notes/list
...
(defn create$
  "https://support.google.com/keepapi/reference/rest/v1/notes/create
  ...
  {:permissions [{:email string,
   ...
   :updateTime string,
   :trashed boolean,
   :body {:list ListContent, :text TextContent}}
...
(defn permissions-batchDelete$
  "https://support.google.com/keepapi/reference/rest/v1/notes/permissions/batchDelete
...
(defn permissions-batchCreate$
  "https://support.google.com/keepapi/reference/rest/v1/notes/permissions/batchCreate

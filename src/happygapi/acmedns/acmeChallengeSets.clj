(ns happygapi.acmedns.acmeChallengeSets
  ...
  See: https://developers.google.com/domains/acme-dns/docs/reference/rest/v1/acmeChallengeSets"
...
(defn rotateChallenges$
  ...
  {:keepExpiredRecords boolean,
   :recordsToRemove [{:updateTime string, :fqdn string, :digest string}],
   :accessToken string,
   :recordsToAdd [{:updateTime string, :fqdn string, :digest string}]}

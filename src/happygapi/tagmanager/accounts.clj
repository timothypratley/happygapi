...
(defn containers-workspaces-triggers-update$
  ...
  {:checkValidation {:key string,
   ...
   :visiblePercentageMax {:key string,
                          :type string,
                          :value string,
                          :map [Parameter],
                          :list [Parameter]},
   ...
   :limit {:key string,
           ...
           :map [Parameter],
           :list [Parameter]},
   :horizontalScrollPercentageList {:key string,
                                    :type string,
                                    :value string,
                                    :map [Parameter],
                                    :list [Parameter]},
   :name string,
   :verticalScrollPercentageList {:key string,
                                  :type string,
                                  :value string,
                                  :map [Parameter],
                                  :list [Parameter]},
   :containerId string,
   :visibilitySelector {:key string,
                        :type string,
                        :value string,
                        :map [Parameter],
                        :list [Parameter]},
   ...
   :waitForTags {:key string,
                 :type string,
                 :value string,
                 :map [Parameter],
                 :list [Parameter]},
   :waitForTagsTimeout {:key string,
                        :type string,
                        :value string,
                        :map [Parameter],
                        :list [Parameter]},
   :continuousTimeMinMilliseconds {:key string,
                                   :type string,
                                   :value string,
                                   :map [Parameter],
                                   :list [Parameter]},
   :filter [{:type string, :parameter [Parameter]}],
   :visiblePercentageMin {:key string,
                          :type string,
                          :value string,
                          :map [Parameter],
                          :list [Parameter]},
   :uniqueTriggerId {:key string,
                     :type string,
                     :value string,
                     :map [Parameter],
                     :list [Parameter]},
   :notes string,
   :maxTimerLengthSeconds {:key string,
                           :type string,
                           :value string,
                           :map [Parameter],
                           :list [Parameter]},
   :interval {:key string,
              ...
              :list [Parameter]},
   :tagManagerUrl string,
   :totalTimeMinMilliseconds {:key string,
                              :type string,
                              :value string,
                              :map [Parameter],
                              :list [Parameter]},
   :intervalSeconds {:key string,
                     :type string,
                     :value string,
                     :map [Parameter],
                     :list [Parameter]},
...
(defn containers-workspaces-variables-update$
  ...
  {:path string,
   ...
   :tagManagerUrl string,
   :variableId string,
   :formatValue {:convertUndefinedToValue Parameter,

(ns happygapi.billingbudgets.billingAccounts
  ...
  See: https://cloud.google.com/billing/docs/how-to/budget-api-overviewdocs/reference/rest/v1/billingAccounts"
...
(defn budgets-create$
  ...
  {:thresholdRules [{:spendBasis string, :thresholdPercent number}],
   ...
   :displayName string,
   :notificationsRule {:schemaVersion string,
...
(defn budgets-list$
  ...
  Optional parameters: pageSize, pageToken, scope

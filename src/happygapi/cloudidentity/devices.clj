...
(defn create$
  ...
  {:networkOperator string,
   ...
   :osVersion string,
   :manufacturer string,
   :androidSpecificAttributes {:ownershipPrivilege string,
...
(defn list$
  ...
  Optional parameters: pageToken, orderBy, pageSize, customer, view, filter
...
(defn deviceUsers-list$
  ...
  Optional parameters: orderBy, filter, pageToken, pageSize, customer
...
(defn deviceUsers-lookup$
  ...
  Optional parameters: androidId, userId, rawResourceId, pageToken, pageSize
...
(defn deviceUsers-clientStates-list$
  ...
  Optional parameters: orderBy, customer, pageToken, filter

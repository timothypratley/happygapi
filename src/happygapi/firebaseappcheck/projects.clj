(ns happygapi.firebaseappcheck.projects
  ...
  See: https://firebase.google.com/docs/app-checkdocs/reference/rest/v1/projects"
...
(defn apps-exchangeDebugToken$
  ...
  {:limitedUse boolean, :debugToken string}
...
(defn apps-debugTokens-patch$
  ...
  {:updateTime string, :token string, :name string, :displayName string}
...
(defn apps-recaptchaEnterpriseConfig-patch$
  ...
  {:tokenTtl string, :name string, :siteKey string}

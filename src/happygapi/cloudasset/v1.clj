...
(defn $
  ...
  Optional parameters: readTimeWindow.endTime, readTimeWindow.startTime, contentType, assetNames
...
(defn $
  ...
  Optional parameters: assetTypes, pageToken, orderBy, query, pageSize
...
(defn $
  ...
  {:outputConfig {:gcsDestination GoogleCloudAssetV1GcsDestination,
   ...
   :analysisQuery {:resourceSelector ResourceSelector,
...
(defn $
  ...
  Optional parameters: query, orderBy, pageToken, assetTypes, pageSize

...
(defn check$
  ...
  Optional parameters: target.web.site, target.androidApp.packageName, source.web.site, source.androidApp.packageName, relation, source.androidApp.certificate.sha256Fingerprint, target.androidApp.certificate.sha256Fingerprint

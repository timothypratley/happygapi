...
(defn check$
  ...
  Optional parameters: target.web.site, target.androidApp.certificate.sha256Fingerprint, source.web.site, relation, target.androidApp.packageName, source.androidApp.packageName, source.androidApp.certificate.sha256Fingerprint

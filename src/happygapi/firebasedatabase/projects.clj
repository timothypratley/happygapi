(ns happygapi.firebasedatabase.projects
  ...
  See: https://firebase.google.com/docs/reference/rest/database/database-management/rest/docs/reference/rest/v1beta/projects"
...
(defn locations-instances-list$
  ...
  Optional parameters: pageToken, showDeleted, pageSize

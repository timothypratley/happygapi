(ns happygapi.youtubereporting.jobs
  ...
  See: https://developers.google.com/youtube/reporting/v1/reports/docs/reference/rest/v1/jobs"
...
(defn reports-list$
  ...
  Optional parameters: createdAfter, pageSize, pageToken, startTimeAtOrAfter, startTimeBefore, onBehalfOfContentOwner

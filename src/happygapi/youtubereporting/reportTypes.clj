(ns happygapi.youtubereporting.reportTypes
  ...
  See: https://developers.google.com/youtube/reporting/v1/reports/docs/reference/rest/v1/reportTypes"
...
(defn list$
  ...
  Optional parameters: onBehalfOfContentOwner, pageToken, pageSize, includeSystemManaged

(ns happygapi.securitycenter.folders
  ...
  See: https://cloud.google.com/security-command-centerdocs/reference/rest/v1/folders"
...
(defn locations-muteConfigs-create$
  "https://cloud.google.com/security-command-centerapi/reference/rest/v1/folders/locations/muteConfigs/create
...
(defn locations-muteConfigs-list$
  "https://cloud.google.com/security-command-centerapi/reference/rest/v1/folders/locations/muteConfigs/list

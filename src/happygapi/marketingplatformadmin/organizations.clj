(ns happygapi.marketingplatformadmin.organizations
  ...
  See: https://developers.google.com/analytics/devguides/config/gmp/v1docs/reference/rest/v1alpha/organizations"
  (:require [cheshire.core :as json]
            [clj-http.client :as http]
            [happy.util :as util]))

(defn get$
  "https://developers.google.com/analytics/devguides/config/gmp/v1api/reference/rest/v1alpha/organizations/get
...
(defn analyticsAccountLinks-setPropertyServiceLevel$
  ...
  {:analyticsProperty string, :serviceLevel string}
